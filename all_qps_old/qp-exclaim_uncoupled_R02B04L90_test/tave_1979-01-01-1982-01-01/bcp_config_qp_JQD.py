...
fpath_ref_data_atm          = '/scratch/snx3000/ppothapa/Era5_python_output/era5_pyicon_1979-1982_1.0x1.0deg.nc'
...
red_list = ['atm_u_250_bias','atm_v_250_bias', 'atm_logv_temp_zave_bias','atm_u_zave_bias','atm_logv_u_zave_bias','atm_v_zave_bias','atm_logv_v_zave_bias']
# --- to plot:
